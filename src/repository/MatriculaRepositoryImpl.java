...
/**
 * Implementação de IMatriculaRepository usando JDBC.
 */
public class MatriculaRepositoryImpl implements IMatriculaRepository {
    ...
    public boolean adicionar(Matricula matricula) {
        try (Connection conn = databaseConnection.getConnection();
            ...
            if (e.getErrorCode() == 1062) {
                System.err.println("[MatriculaRepository] Matrícula duplicada");
            } else {
                System.err.println("[MatriculaRepository] Erro SQL: " + e.getMessage());
            }
            return false;
        }
    }
    ...
    public List<Matricula> listarPorDiscente(String discenteId) {
        ...
        try {
            ...
            if (conn == null) {
                System.err.println("[MatriculaRepository] Falha ao obter conexão com o banco.");
                return matriculas;
            }
            ...
            System.err.println("[MatriculaRepository] Erro ao listar matrículas: " + e.getMessage());
    ...
    public int contarMatriculasPorDiscente(String discenteId) {
        try (Connection conn = databaseConnection.getConnection();
            ...
            System.err.println("[MatriculaRepository] Erro ao contar: " + e.getMessage());
            return 0;
        }
    }
    ...
    public boolean existeMatricula(String discenteId, String disciplinaId) {
        try (Connection conn = databaseConnection.getConnection();
            ...
            System.err.println("[MatriculaRepository] Erro ao verificar: " + e.getMessage());
            return false;
        }
    }
    ...
    public Matricula buscarPorCodigo(String codigoMatricula) {
        try (Connection conn = databaseConnection.getConnection();
            ...
            System.err.println("[MatriculaRepository] Erro ao buscar: " + e.getMessage());
            return null;
        }
    }
}
